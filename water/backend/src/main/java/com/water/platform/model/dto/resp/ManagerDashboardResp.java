...
@ApiModel(description = "监管局看板数据")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class ManagerDashboardResp {

    @ApiModelProperty(value = "管辖养殖户数")
    private Long farmerCount;

    @ApiModelProperty(value = "管辖养殖池总数")
    private Long pondCount;

    @ApiModelProperty(value = "养殖中养殖池数")
    ...
    @ApiModelProperty(value = "按类型分组的审核统计")
    private Map<String, AuditTypeStat> auditByType;
